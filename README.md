...
- [Live Demo Link](https://adams-ghub.github.io/To-do_list/dist/)
...
<ol>
    ...
    <li>Run the command "git clone git@github.com:Adams-Ghub/to-do-list.git" in the terminal or command line</li>
